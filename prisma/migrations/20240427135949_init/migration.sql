...
-- CreateIndex
CREATE INDEX "Slider_storeId_idx" ON "Slider"("storeId");
...
-- AddForeignKey
ALTER TABLE "Slider" ADD CONSTRAINT "Slider_storeId_fkey" FOREIGN KEY ("storeId") REFERENCES "Store"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
